...
public class SysPropertyUtils {
    ...
    private static final String LOAD_PROPERTIES = "SELECT param_key,param_value FROM sys_config";
    private static final String UPDATE_PROPERTY = "UPDATE sys_config SET param_value=? WHERE param_key=?";
